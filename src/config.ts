...
export function loadConfig(env: NodeJS.ProcessEnv = process.env): Config {
  ...
  return {
    ...
    deployReadyWindowMs:
      numEnvStrict("DEPLOY_READY_WINDOW_MS", env.DEPLOY_READY_WINDOW_MS) ?? CONFIG_DEFAULTS.deployReadyWindowMs,
    ...deployAppsEnv(env),
    deepIdleMachineMs:
